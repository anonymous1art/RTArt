...
# logging.getLogger("Utils.CoQAUtils").setLevel(logging.DEBUG)
#logging.getLogger("Models.Bert.Bert").setLevel(logging.DEBUG)
#logging.getLogger("Models.SDNetTrainer").setLevel(logging.DEBUG)
#print('DEBUG starts')
